...
export default defineComponent({
  data() {
    return {
      ...
      secondTableData: [
        { projectId: 'PR001', prn: '12345', user: 'User1', date: '2023-04-15', notification: 'Notification 1' },
        { projectId: 'PR002', prn: '67890', user: 'User2', date: '2023-05-20', notification: 'Notification 2' },
      ],
    };
  },
  mounted() {
